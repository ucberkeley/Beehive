...
describe SessionsController do
      ...
      [ true, false ].each do |want_remember_me|
        describe "my request cookie token is #{has_request_token.to_s}," do
          describe "and ask #{want_remember_me ? 'to' : 'not to'} be remembered" do 
            ...
            it 'redirects to the home page'  do do_create; response.should redirect_to(:controller=>:dashboard)   end
  ...
  describe "on failed login" do
    ...
    it 'flashes an error'           do do_create; flash[:error].should =~ /Couldn't log you in as 'quentin@berkeley.edu'/ end
...
describe SessionsController do
  describe "route generation" do
    ...
    it "should route the show sessions correctly" do
