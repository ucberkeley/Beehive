...
describe UsersController do
  describe "routing" do
    context "while logged in via CAS" do 
    
      before(:each) do 
        SpecHelperMethods.stub_cas_ok
      end
    
      it "should not recognize or generates #new for users" do
        { :get => "/users/new" }.should_not route_to(:controller => "users", :action => "new")
      end

      it "recognizes and generates #show for this user" do
