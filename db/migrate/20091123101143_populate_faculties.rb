class PopulateFaculties < ActiveRecord::Migration
  def self.up
	...
	Faculty.create :name => "Björn Hartmann", :email => "bjoern@eecs.berkeley.edu", :department => "EECS"
	...
	Faculty.create :name => "Carlo H. Séquin", :email => "sequin@cs.berkeley.edu", :department => "EECS"
